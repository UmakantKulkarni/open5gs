        ...
        ogs_pfcp_session_establishment_response_t *rsp, pcs_fsm_struct_t *pcs_fsmdata)
{
    ...
    if (pcs_fsmdata->pcs_dbcommenabled && !pcs_fsmdata->pcs_isproceduralstateless)
    {
        ...
        if (pcs_createdone)
        {
            ...
            pcs_n4createdata = pcs_get_smf_n4_create_data(sess, xact);
    ...
    else if (pcs_fsmdata->pcs_dbcommenabled && pcs_fsmdata->pcs_isproceduralstateless && sess->pcs.pcs_createdone)
    {
        ...
        struct pcs_smf_n4_create pcs_n4createdata = pcs_get_smf_n4_create_data(sess, xact);
